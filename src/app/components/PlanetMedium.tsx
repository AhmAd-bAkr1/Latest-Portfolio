  ...
  return (
    <group ref={shapeContainer} {...props} dispose={null}>
      <group ref={shperesContainer}>
        {/* تصغير Sphere الثاني لتخفيف الحمل */}
        <mesh
          castShadow
          receiveShadow
        ...
        <mesh
          ...
          rotation={[0, 0, 0.741]}
          scale={0.15} // <- قللت الحجم لتخفيف التفاصيل
        />
      </group>
      <mesh
        ref={ringContainer}
        ...
        scale={1.5} // <- قللت الحجم قليلاً لتخفيف الحمل
      />
    </group>
  );
};
